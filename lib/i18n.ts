...
const translations = {
  en: {
    ...
    feat_zotero: "Save to Zotero",
    feat_zotero_sub: "One-click sync to your Zotero library",
    feat_ai_model: "Better AI model",
    feat_ai_model_sub: "Claude Sonnet for higher accuracy",
    ...
    gk_daily_title: "3 free searches per day.",
    ...
    signin_editorial_label: "An editorial tool for researchers",
    signin_description: "Paste a paragraph of your draft. We surface supporting papers from OpenAlex and Semantic Scholar \u2014 ranked by relevance, matched to the exact sentence.",
    sign_in_or_guest: "Sign in or continue as guest",
    welcome_back: "Welcome back.",
    signin_subtitle: "Pick up where you left off, or start a fresh manuscript.",
    ...
    sign_in_btn: "Sign in",
    sign_in_email_btn: "Sign in with email",
    forgot_password: "Forgot password?",
    terms: "Terms",
    privacy_policy: "Privacy Policy",
    signin_terms: "By continuing, you agree to our",
    and: "and",
    searches_day: "searches / day",
  ...
  zh: {
    ...
    feat_zotero: "保存到 Zotero",
    feat_zotero_sub: "一键同步到您的 Zotero 文库",
    feat_ai_model: "更强大的 AI 模型",
    feat_ai_model_sub: "Pro 用户使用 Claude Sonnet，精度更高",
    ...
    signin_editorial_label: "面向研究者的学术工具",
    signin_description: "粘贴您草稿中的段落。我们从 OpenAlex 和 Semantic Scholar 提取相关论文\u2014\u2014按相关性排名，精确匹配到每个句子。",
    sign_in_or_guest: "登录或以访客身份继续",
    welcome_back: "欢迎回来。",
    signin_subtitle: "从上次中断的地方继续，或开始新的稿件。",
    stat_papers: "真实收录论文数",
    ...
    create_account: "创建账户",
    sign_in_btn: "登录",
    sign_in_email_btn: "使用邮箱登录",
    forgot_password: "忘记密码？",
    terms: "条款",
    privacy_policy: "隐私政策",
    signin_terms: "继续即表示您同意我们的",
    and: "和",
    searches_day: "次搜索 / 天",
  ...
  ja: {
    ...
    feat_zotero: "Zotero に保存",
    feat_zotero_sub: "ワンクリックで Zotero ライブラリに同期",
    feat_ai_model: "より高精度な AI モデル",
    feat_ai_model_sub: "Pro は Claude Sonnet で高精度",
    ...
    signin_editorial_label: "研究者のための学術ツール",
    signin_description: "草稿の段落を貼り付けてください。OpenAlex と Semantic Scholar から関連論文を抽出し、関連性でランク付けして各文に正確に一致させます。",
    sign_in_or_guest: "サインインまたはゲストとして続ける",
    welcome_back: "おかえりなさい。",
    signin_subtitle: "前回の続きから、または新しい原稿を始めましょう。",
    stat_papers: "収録論文数",
    stat_languages: "対応言語",
    stat_formats: "引用形式",
    ...
    sign_in_btn: "サインイン",
    sign_in_email_btn: "メールでサインイン",
    forgot_password: "パスワードをお忘れですか？",
    terms: "利用規約",
    privacy_policy: "プライバシーポリシー",
    signin_terms: "続行することで、当社の",
    and: "および",
    searches_day: "回検索 / 日",
  ...
  ko: {
    ...
    feat_zotero: "Zotero에 저장",
    feat_zotero_sub: "클릭 한 번으로 Zotero 라이브러리에 동기화",
    feat_ai_model: "더 강력한 AI 모델",
    feat_ai_model_sub: "Pro는 Claude Sonnet으로 높은 정확도",
    ...
    signin_editorial_label: "연구자를 위한 학술 도구",
    signin_description: "초안의 단락을 붙여넣으세요. OpenAlex와 Semantic Scholar에서 관련 논문을 찾아 관련성 순으로 순위를 매기고 각 문장에 정확히 매칭합니다.",
    sign_in_or_guest: "로그인 또는 게스트로 계속",
    welcome_back: "다시 오셨군요.",
    signin_subtitle: "지난 작업을 이어가거나 새 원고를 시작하세요.",
    stat_papers: "수록 논문 수",
    ...
    sign_in_btn: "로그인",
    sign_in_email_btn: "이메일로 로그인",
    forgot_password: "비밀번호를 잊으셨나요?",
    terms: "이용약관",
    privacy_policy: "개인정보 처리방침",
    signin_terms: "계속하면 당사의",
    and: "및",
    searches_day: "회 검색 / 일",
